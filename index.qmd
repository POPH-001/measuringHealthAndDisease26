...
author: "College of Health @ LEHIGH | Eric Delmelle <br> February 9, 11, 23 2026"
format:
  revealjs: 
    slide-number: true
  pdf: default
...
## [**Table of Contents**]{style="color: teal;"}

### [Part 1: Comparing Health Events]{style="color: pink;"}
...
### [Part 2: Measuring Health and Disease]{style="color: pink;"}
::: {style="font-size: 0.8em;"}
...
## [**Types of Comparisons**]{style="color: teal;"}

### [**Time-Based**]{style="color: pink;"}

![](imgs/timeBased.jpg){fig-align="center" width="70%"}
...
![](imgs/placeBased.jpg){fig-align="center" width="70%"}
...
![](imgs/covid19.png){fig-align="center" width="70%"}
...
![](imgs/polio.jpg){fig-align="center" width="70%"}

------------------------------------------------------------------------

### [**Additional Event-Based Example**]{style="color: pink;"}

![](imgs/polio2.jpg){fig-align="center" width="70%"}
...
![](imgs/dataDrivenComparison.png){fig-align="center" width="80%"}
...
## [**Introduction to Measurement**]{style="color: teal;"}
...
-   **Prevalence Formula Relation:**
    ...
    -   check this [youTube](https://www.youtube.com/watch?v=XXJl2C1PxTQ&t=275s){.uri} video
...
::: {.column width="35%"}
[**Why different times?**]{style="font-size: 0.75em;"}
...
### [**Qatar and Japan Age Pyramids**]{style="color: pink;"}
...
![](imgs/japanPyramid.jpg){fig-align="center" width="100%"}
:::
:::
...
- Choose an age pyramid.
    - [international](https://www.populationpyramid.net/){.uri} pyramid.
    - [local level](https://usafacts.org/data/topics/people-society/population-and-demographics/our-changing-population/){.uri} pyramid.
...
## [**Mortality Metrics**]{style="color: teal;"}

### [**Crude Death Rate (CDR)**]{style="color: pink;"}
...
### [**Case Fatality Rate (CFR)**]{style="color: pink;"}
::: {style="font-size: 0.8em;"}
...
### [**Standardized Mortality Ratio (SMR)**]{style="color: pink;"}
...
## [**Life Table Construction**]{style="color: teal;"}

### [**Steps in Constructing a Life Table (1)**]{style="color: pink;"}
...
### [**Steps in Constructing a Life Table (2)**]{style="color: pink;"}
...
## [**Years of Life Lost**]{style="color: teal;"}
...
#### [**Definition of Premature Mortality Age**]{style="color: pink;"}
...
#### [**Identification of Age at Death**]{style="color: pink;"}
